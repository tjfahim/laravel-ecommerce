                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" enctype="multiple/form-data" wire:submit.prevent="updateProduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 control-label" wire:ignore>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Quantity" class="col-md-4 control-label" value="" wire:model='quantity'>
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-md-4">
                                    <button type="submit" class="btn btn-primary" wire:model='name'>Update</button>
                                </div>
                            </div>
