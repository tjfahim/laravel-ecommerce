                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($order->status=='ordered')
                                    <a href="#" wire:click.prevent="cancelOrder" style="margin-right: 15px" class="btn btn-warning pull-right">Cancel Order</a>
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach ($order->orderItems as $item )
                                    <li class="pr-cart-item">
                                        ...
                                        @if ($order->status=='delivered' && $item->rstatus==false)
                                            <div class="price-field sub-total"><p class="price"><a href="{{route("user.review",['order_item_id'=>$item->id])}}"> Write Reviews</a></p></div>
                                        @endif
                                    </li>
                                @endforeach
                            </ul>
