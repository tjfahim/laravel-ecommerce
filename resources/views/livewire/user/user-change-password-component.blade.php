                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent='ChangePassword'>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="Current Password" class="form-control input-md" name="current_password" id="" wire:model='current_password'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="New Password" class="form-control input-md" name="new_password" id="" wire:model='password'>
                                    @error('current_password')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="Confirm Password" class="form-control input-md" name="confirm_password" id="" wire:model='confirm_password'>
                                    @error('current_password')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                                </div>
