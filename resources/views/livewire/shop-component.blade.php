			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					...
					<div class="wrap-pagination-info">
						...
						<p class="result-count">Showing 1-8 of 22  result</p> --}}
					</div>
							...
							<ul class="list-category">
								@foreach ($categories as $category )
                                    <li class="category-item">
                                        <a href="{{route('category.product',['category_slug'=>$category->slug])}}" class="cate-link">{{$category->name}}</a>
                                    </li>
                                @endforeach
							</ul>
						</div>
...
{{--
                    ...
                    <div class="widget mercado-widget filter-widget price-filter mb-40">
                        <h2 class="widget-title">Price <span class="text-info">${{$min_price}} - ${{$max_price}}</span></h2>
                        <div class="widget-content">
                            <div id="slider" wire:ignore style="margin-bottom:40px"></div>
                        </div>
                    </div>
