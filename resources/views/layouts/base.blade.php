...
<head>
    ...
    {{-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/6-beta8/css/tempus-dominus.min.css" integrity="sha512-MAE2fieZOXaN7hawt+GziEfza/z8IyG2Xbt2Aw68NrTPzHBzOF66A0/Vr5PU+MgFs1H4/uWH6AbANhuxZT03Hw==" crossorigin="anonymous" referrerpolicy="no-referrer" /> --}}
...
<body class="home-page home-01 ">
                                        ...
                                        @if (Auth::user()->utype ==='ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item" >
														<a title="Home Slider " href="{{route('admin.slider')}}">Manage Home Slider</a>
													</li>
													<li class="menu-item" >
													...
													<li class="menu-item" >
														<a title="All coupons" href="{{route('admin.order')}}">All Orders</a>
													</li>
													<li class="menu-item" >
														<a title="All coupons" href="{{route('admin.contact')}}">Contact Messages</a>
													</li>
													<li class="menu-item" >
														<a title="All coupons" href="{{route('admin.setting')}}">Settings</a>
													</li>

                                                    {{-- <li class="menu-item">
                                                        <a href="{{route('logout')}}" id="logout-form" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout</a>
                                                    </li>
                                                        ...
                                                        <form method="POST" action="{{ route('logout') }}">
                                                            ...
                                                            <li class="menu-item">
                                                                <a  href="{{ route('logout') }}" onclick="event.preventDefault();
                                                                            this.closest('form').submit(); " role="button"> Logout
                                                                </a>
                                                            </li>
                                                        </form>
                                                    {{-- @else
                                                        <li class="menu-item">
                                                            <a class="menu-link" href="{{ route('login') }}" role="button">
                                        ...
                                        @else
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item" >
														<a title="My Orders" href="{{route('user.order')}}">My Orders</a>
													</li>
													<li class="menu-item" >
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="/shop" class="link-term mercado-item-title" id="shop">Shop</a>
								</li>
								<li class="menu-item">
    ...
    <script src="https://cdn.tiny.cloud/1/yffwfwk3jqaq45jndnra30t87gq0x7ct353e539sltu37zsw/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
